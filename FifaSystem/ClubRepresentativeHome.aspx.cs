...
{
    public partial class ClubRepresentativeHome : System.Web.UI.Page
    {
        ...
        protected void viewClubButton_Click(object sender, EventArgs e)
        {
            Response.Redirect("viewClubInfo.aspx");
        }

        protected void viewUpcomingMatchesButton_Click(object sender, EventArgs e)
        {
            Response.Redirect("viewUpcomingMatchesOfClubRepresentative.aspx");
        }

        protected void viewAvailableStadiumsButton_Click(object sender, EventArgs e)
        {
