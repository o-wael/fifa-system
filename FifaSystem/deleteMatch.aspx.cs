...
namespace FifaSystem
{
    ...
    {
        protected void doJob(object sender, EventArgs e, String hostName, String guestName)
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["user"] != null)
            {
                ...
                else
                {
                    ...
                    trial.CommandText = "Select * From allMatches";
