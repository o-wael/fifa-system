<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deleteClub.aspx.cs" Inherits="FifaSystem.deleteClub" %>
        ...
        <div>
            ...
            <asp:Table ID="mainTable" runat="server">
                <asp:TableHeaderRow ID="tableHeaderC"> 
                    <asp:TableCell>Club Name</asp:TableCell>
                    <asp:TableCell>Club Location</asp:TableCell>
