<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registerStadiumManager.aspx.cs" Inherits="FifaSystem.registerStadiumManager" %>
  ...
        </section>
    <form class ="formC"  id="form1" runat="server">
        <div>
            ...
            <br />
            Stadium Name:<br />
            <asp:TextBox ID="stadiumName" MaxLength="20" placeholder="Stadium Name" runat="server"></asp:TextBox>
            <br />
            <br />
